...
ROUNDS = {
    "r32": ("Round of 32", "to advance", [
        ...
        ("Mexico", "Ecuador", "Tue Jun 30, 9:00 PM"),
        ("England", "DR Congo", "Wed Jul 1, 12:00 PM"),
        ("Belgium", "Senegal", "Wed Jul 1, 4:00 PM"),
        ("USA", "Bosnia and Herzegovina", "Wed Jul 1, 8:00 PM"),
        ("Spain", "Austria", "Thu Jul 2, 3:00 PM"),
        ("Portugal", "Croatia", "Thu Jul 2, 7:00 PM"),
        ("Switzerland", "Algeria", "Thu Jul 2, 11:00 PM"),
        ("Australia", "Egypt", "Fri Jul 3, 2:00 PM"),
        ("Argentina", "Cape Verde", "Fri Jul 3, 6:00 PM"),
        ("Colombia", "Ghana", "Fri Jul 3, 9:30 PM"),
    ]),
